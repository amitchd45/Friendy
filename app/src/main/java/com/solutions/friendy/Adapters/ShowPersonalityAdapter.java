...
public class ShowPersonalityAdapter extends RecyclerView.Adapter<ShowPersonalityAdapter.ViewHolder> {

    Context context;
    private List<String> datalist;

    public ShowPersonalityAdapter(Context context, List<String> datalist) {
