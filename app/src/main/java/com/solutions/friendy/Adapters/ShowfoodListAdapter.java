...
public class ShowfoodListAdapter extends RecyclerView.Adapter<ShowfoodListAdapter.ViewHolder> {

    Context context;
    private List<String> datalist;

    public ShowfoodListAdapter(Context context, List<String> datalist) {
