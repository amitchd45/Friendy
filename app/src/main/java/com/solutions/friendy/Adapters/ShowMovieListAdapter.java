...
public class ShowMovieListAdapter extends RecyclerView.Adapter<ShowMovieListAdapter.ViewHolder> {

    Context context;
    private List<String> datalist;

    public ShowMovieListAdapter(Context context, List<String> datalist) {
