...
public class ShowMusicListAdapter extends RecyclerView.Adapter<ShowMusicListAdapter.ViewHolder> {

    Context context;
    private List<String> datalist;

    public ShowMusicListAdapter(Context context, List<String> datalist) {
